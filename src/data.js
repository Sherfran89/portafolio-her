export const translations = {
  es: {
      ...
      skills_subtitle: "Herramientas que utilizo para potenciar tu marca",
      skill_html_title: "HTML5 & CSS3",
      skill_html_desc: "Estructura semántica y maquetación visual responsiva y moderna.",
      skill_js_title: "JavaScript",
      skill_js_desc: "Interactividad avanzada y lógica de negocio dinámica en el lado del cliente.",
      skill_react_title: "React.js",
      skill_react_desc: "Desarrollo de aplicaciones web ágiles, rápidas y estructuradas por componentes.",
      skill_ts_title: "TypeScript",
      skill_ts_desc: "Tipado estático para código más robusto, predecible y fácil de mantener.",
      skill_node_title: "Node.js & Backend",
      skill_node_desc: "Creación de APIs REST, manejo de bases de datos y lógica de servidor.",
      skill_api_title: "Integración de APIs",
      skill_api_desc: "Conexión fluida con servicios externos, pasarelas de pago y datos en tiempo real.",
      skill_figma_title: "Figma",
      skill_figma_desc: "Diseño e interfaz de usuario interactiva (UI/UX) antes del desarrollo.",
      skill_meta_title: "Meta Ads",
      skill_meta_desc: "Publicidad paga optimizada en Facebook e Instagram para captar ventas.",
      skill_canva_title: "Canva & Branding",
      skill_canva_desc: "Creación ágil de piezas visuales y contenido gráfico alineados con tu marca.",
      skill_ai_title: "I.A. Estratégica",
      skill_ai_desc: "Automatización con ChatGPT y Gemini para copywriting y optimización de flujos.",
      skill_video_title: "Edición & Storytelling",
      skill_video_desc: "Edición dinámica en CapCut con subtítulos animados de alta retención.",
      skill_audio_title: "Producción Audiovisual",
      skill_audio_desc: "Voz en off, jingles y diseño sonoro a medida para campañas de marketing.",
  ...
  en: {
      ...
      skills_subtitle: "Tools I use to supercharge your brand",
      skill_html_title: "HTML5 & CSS3",
      skill_html_desc: "Semantic structures and modern responsive layout styles.",
      skill_js_title: "JavaScript",
      skill_js_desc: "Advanced client-side interactivity and dynamic application logic.",
      skill_react_title: "React.js",
      skill_react_desc: "Fast, component-based web applications with high modularity.",
      skill_ts_title: "TypeScript",
      skill_ts_desc: "Static typing for more robust, predictable, and maintainable code.",
      skill_node_title: "Node.js & Backend",
      skill_node_desc: "Creation of REST APIs, database management, and server-side logic.",
      skill_api_title: "API Integration",
      skill_api_desc: "Seamless connection with external services, payment gateways, and real-time data.",
      skill_figma_title: "Figma",
      skill_figma_desc: "High-fidelity interactive UI/UX prototyping and layout design.",
      skill_meta_title: "Meta Ads",
      skill_meta_desc: "Optimized paid campaigns on Facebook & Instagram targeting conversion.",
      skill_canva_title: "Canva & Branding",
      skill_canva_desc: "Visual templates and graphic content aligned with your brand identity.",
      skill_ai_title: "Strategic AI",
      skill_ai_desc: "Workflow automation and smart copywriting using ChatGPT & Gemini.",
      skill_video_title: "Editing & Storytelling",
      skill_video_desc: "Dynamic edits in CapCut featuring high-retention subtitles.",
      skill_audio_title: "Audiovisual Production",
      skill_audio_desc: "Custom voice-overs, background music, and sonic branding for ads.",
      footer_location: "Córdoba, Argentina.",
